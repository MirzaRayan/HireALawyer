...
const LawyerLogin = () => {
  ...
  const onSubmit = async (data) => {
   ...
   try {
     const response = await axios.post('http://localhost:5000/lawyer/logininlawyer',data)
          ...
          <div className ="containerLogin">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className ="form-containerLogin">
                ...
                <Button className='Register-btnLogin' onClick={clientLogin}>Login as Client</Button>
